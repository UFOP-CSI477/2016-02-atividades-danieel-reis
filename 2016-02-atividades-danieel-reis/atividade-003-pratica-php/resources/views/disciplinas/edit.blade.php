    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading" align="center"><b>Editar Disciplina<b></div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group{{ $errors->has('nome') ? ' has-error' : '' }}">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nome" value="{{ $disciplina->nome }}" required autofocus/>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group{{ $errors->has('codigo') ? ' has-error' : '' }}">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="codigo" value="{{ $disciplina->codigo }}" required autofocus/>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group{{ $errors->has('carga') ? ' has-error' : '' }}">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="carga" value="{{ $disciplina->carga }}" required autofocus/>
                                </div>
                            </div>
